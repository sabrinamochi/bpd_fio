...
function draw() {
  ...
  const mapEnter = map.enter()
    ...
    .attr("stroke", "black")
    .attr("fill", d => biMapFill(d, "crime", "stopped_per", crimeStopColorRange))
